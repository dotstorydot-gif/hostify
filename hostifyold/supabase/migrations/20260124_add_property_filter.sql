-- Update Analytics Function to support Property Filtering
...
BEGIN
  ...
  IF v_property_count > 0 THEN
    -- If filtering by one property, property_count is 1. Calculation holds.
  ...
  -- Units (If filtered by property, this will show units for that property only, or just the property name itself)
  ...
  -- Expenses by Property (If filtered, only one property shown)
